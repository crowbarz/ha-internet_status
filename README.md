...
| `debug_probe` | object | `false` | enables additional debug logging for each DNS probe. See [Enabling debugging](#enabling-debugging) for details.
...
| `debug_rtt` | object | `false` | enables additional debug logging for RTT sensor updates. See [Enabling debugging](#enabling-debugging) for details.
